...
const InstructionList = [
    ...
    {index: 4, list: ["Dice the avocado,carrots,cucumber,and spinach", "Line bamboo rolling paper, add seaweed and sushi rice", "Add avocado, carrots, cucumbers, and spinach evenly throughout", "Roll the bamboo rolling paper, and "]},
